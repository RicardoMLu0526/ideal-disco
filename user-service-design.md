...
用户服务是整个电商系统的基础服务，负责用户的注册、登录、认证、信息管理等核心功能。该服务采用微服务架构设计，与其他服务通过RESTful API进行通信。
...
public class SentinelConfig {
    ...
    public void initRules() {
        ...
        rule.setResource("/api/auth/login");
        ...
        degradeRule.setResource("/api/auth/login");
        degradeRule.setCount(50); // 异常比例
